...
(function (win) {
     ...
     */
    //"use strict";
	//var opendWindowObj = window.open(document.location.protocol+'//'+document.location.hostname+":"+document.location.port+'/'+document.location.hash);
